...
import fr from '../ressources/lang/fr.json';
import en from '../ressources/lang/en.json';
import jp from '../ressources/lang/jp.json';
import es from '../ressources/lang/es.json';
